...
module.exports = {
    async athletes_trainings_results(_, args, ctx) {
        return db
            .select(['athletes_training_results.id', 'athletes_training_results.collaborator_athlete_id', 'athletes_training_results.training_id', 'athletes_training_results.result_id', 'athletes_training_results.status', 'team_category.user_id'])
            .distinct('athletes_training_results.id')
            .orderBy('athletes_training_results.id', 'asc')
